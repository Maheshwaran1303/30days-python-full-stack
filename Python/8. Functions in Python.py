...
welcome(name="Mahesh", message="Hi")  # Outputs: Hi, Mahesh!
welcome(name="Mahesh")  # Outputs: Hello, Mahesh! (using default message)
...
# Passing keyword arguments
print_details(name="Mahesh", age=25, city="Tenkasi")
...
# The map() function in Python applies a given function to all the items in an input iterable (such as a list,  tuple, etc.) and returns a map object (which can be converted into a list, tuple, etc.). 
