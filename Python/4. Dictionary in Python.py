...
# Example:
my_dict = {"name": "Mahesh", "age": 25, "city": "Tenkasi"}

### *2. Creating and Accessing Dictionaries*

#### a) *Creating a Dictionary*
# Example:
my_dict = {"name": "Mahesh", "age": 25, "profession": "Manager"}

#### b) *Accessing Values by Key*
# Use the key to access a value.
# Example:
print(my_dict["name"])  # Outputs: Mahesh
...
# Example:
my_dict = {"name": "Mahesh", "age": 25}
my_dict["city"] = "Surandai"  # Adding a new key-value pair
my_dict["age"] = 30  # Updating an existing key's value
print(my_dict)  # Outputs: {'name': 'Mahesh', 'age': 30, 'city': 'Surandai'}
...
my_dict = {"name": "Mahesh", "age": 25, "city": "Tenkasi"}
my_dict.pop("city")
print(my_dict)  # Outputs: {'name': 'Mahesh', 'age': 30}

del my_dict["age"]
print(my_dict)  # Outputs: {'name': 'Mahesh'}
...
# Example:
my_dict = {"name": "Mahesh", "age": 30}
print(my_dict.keys())  # Outputs: dict_keys(['name', 'age'])
print(my_dict.values())  # Outputs: dict_values(['Mahesh', 30])
print(my_dict.items())  # Outputs: dict_items([('name', 'Mahesh'), ('age', 30)])
...
print(new_dict)  # Outputs: {'name': 'Mahesh', 'age': 25}
...
# Example:
nested_dict = {
    "person1": {"name": "Manish", "age": 25},
    "person2": {"name": "Mahesh", "age": 25}
}

#### b) *Accessing Nested Dictionary Elements*
# Example:
print(nested_dict["person1"]["name"])  # Outputs: Manish
...
people = {"Mahesh": 30, "Bob": 25, "Charlie": 35}
people["Diana"] = 28  # Adding a new person
people["Mahesh"] = 31  # Updating Mahesh's age
print(people)  # Outputs: {'Mahesh': 31, 'Bob': 25, 'Charlie': 35, 'Diana': 28}
...
people_info = {
    ...
    "person2": {"name": "Mahesh", "age": 30, "profession": "Engineer"}
}
